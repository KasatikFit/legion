    <!-- Модальное окно спортсмена (главная страница) -->
    ...
    <div class="modal-overlay" id="infoModal" onclick="closeInfoModal(event)">
        <div class="modal" onclick="event.stopPropagation()">
            ...
            <ul>
                <li>В каждом упражнении (отжимания, подтягивания, вис, бёрпи, прыжок) спортсмены получают очки за занятое место.</li>
            ...
            <ul>
                <li>Внутри группы каждого тренера очки считаются только среди его воспитанников.</li>
            ...
            <ul>
                ...
                <li>Лучшие 25 по сумме очков формируют <strong>ТОП‑25 Легиона Силы</strong> — элиту клуба.</li>
